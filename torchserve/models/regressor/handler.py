...
class SimpleHandler(BaseHandler):
    ...
    def initialize(self, context):
        ...
        # else:
        #     logging.warning('model_config.json file not found')
        #     self.input_dim = 2
        try:
            self.input_dim = self.context.model_yaml_config["fan_in"]
        except:
            logging.warning('fan in not defined in model_config.yaml')
            self.input_dim = 2
